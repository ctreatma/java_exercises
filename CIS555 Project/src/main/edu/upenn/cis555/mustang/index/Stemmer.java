...
/**
 * Open source code from http://tartarus.org/~martin/PorterStemmer/java.txt
 * 
 * Stemmer class implementing the Porter Stemming Algorithm transforms a word 
 * into its root form.  The input word can be provided a character at time by 
 * calling add(..), or at once by calling one of the various stem(..) methods.
 */
public class Stemmer {
	...
	public static void main(String[] args) {
		...
		/* test add(char[] w, int j) */
		s.add(w, w.length);
		s.stem();
		System.out.println(s.toString());
		w = "connecting".toCharArray();
		s.add(w, w.length);
		s.stem();
		System.out.println(s.toString());
	}
