...
public class IndexerMessage implements Message {
    ...
    public IndexerMessage(NodeHandle from, String mapKey, Type type, String keyword) {
        this(from, mapKey, type, keyword, null);
    }
    
    public IndexerMessage(NodeHandle from, String mapKey, Type type, String keyword, String videoFeedHtml) {
        this.from = from;
        this.mapKey = mapKey;
        this.type = type;
